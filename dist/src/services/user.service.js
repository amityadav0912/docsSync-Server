...
class UserService {
    constructor() {
        ...
        this.generateAuthResponse = (user) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield refresh_token_model_1.RefreshToken.destroy({ where: { userId: requestUser.id } });
            }
            catch (error) {
        ...
        this.resetPassword = (user) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sendPasswordResetMail(user);
        });
        this.sendPasswordResetMail = (user) => __awaiter(this, void 0, void 0, function* () {
            const mail = {
                from: "amit09yadav12@gmail.com",
                to: user.email,
        ...
        this.findUserByPasswordResetToken = (email, passwordResetToken) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_model_1.User.findOne({ where: { email, passwordResetToken } });
            return user;
        });
