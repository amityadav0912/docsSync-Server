...
const documnet_user_model_1 = require("./documnet-user.model");
...
const sequelize_typescript_1 = __importDefault(require("sequelize-typescript"));
db_config_1.default.addModels([
    ...
    documnet_user_model_1.DocumentUser
]);
const db = {
    sequelize: db_config_1.default,
    Sequelize: sequelize_typescript_1.default,
    ...
    DocumentUser: documnet_user_model_1.DocumentUser
};
exports.default = db;
